...
export default function BooksSearchBar({ onSearch }) {
    ...
    return (
        <div className="flex bg-backgrounds max-w-full border border-light-border px-6 py-2 gap-2 focus-within:outline-2 focus-within:outline-offset-2 focus-within:outline-sky-700   rounded-full">
            <div className="w-6 h-6 md:w-8 md:h-8 bg-primary text-white flex justify-center items-center rounded-full">
                <Search className="w-2 h-2 md:w-4 md:h-4" />
            </div>
            <input
